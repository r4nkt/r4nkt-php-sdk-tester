...
class PrepGame extends AbstractTask
{
    ...
    protected function buildActions()
    {
        $actions = [
            ...
            [
                'custom_id' => 'action.defeat.ethereal.queen.as.cleric',
                'name' => 'action.defeat.ethereal.queen.as.cleric',
                'reactions' => [
                    'action.defeat.ethereal.queen',
                ],
            ],
            [
                'custom_id' => 'action.defeat.ethereal.queen.as.rogue',
                'name' => 'action.defeat.ethereal.queen.as.rogue',
                'reactions' => [
                    'action.defeat.ethereal.queen',
                ],
            ],
            [
                'custom_id' => 'action.defeat.ethereal.queen.as.warrior',
                'name' => 'action.defeat.ethereal.queen.as.warrior',
                'reactions' => [
                    'action.defeat.ethereal.queen',
                ],
            ],
            [
                'custom_id' => 'action.defeat.ethereal.queen.as.wizard',
                'name' => 'action.defeat.ethereal.queen.as.wizard',
                'reactions' => [
                    'action.defeat.ethereal.queen',
                ],
            ],
